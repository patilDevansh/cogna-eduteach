...
const COVERAGE_TARGETS = {
  P1_INTEGER_ADD_SUB: 20,
  P2_NEGATIVE_OPS: 15,
  P3_VARIABLES_CONSTANTS: 15,
  P4_SIMPLE_EXPRESSIONS: 20,
  P5_EQUALITY_BALANCE: 20,
  C1_ONE_STEP_ADDITION: 20,
  C2_ONE_STEP_SUBTRACTION: 25,
  C3_ONE_STEP_MULTIPLICATION: 20,
  C4_ONE_STEP_DIVISION: 20,
  C5_TWO_STEP_EQUATIONS: 25,
  C6_SIMPLE_WORD_PROBLEMS: 20,
};
